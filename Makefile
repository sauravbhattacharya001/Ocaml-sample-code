...
OCAML = ocamlopt
SOURCES = hello.ml fibonacci.ml factor.ml list_last_elem.ml bst.ml mergesort.ml graph.ml dijkstra.ml heap.ml parser.ml trie.ml regex.ml stream.ml rbtree.ml sorting.ml union_find.ml rope.ml
TARGETS = $(SOURCES:.ml=)
