...
| [`gap_buffer.ml`](gap_buffer.ml) | Gap buffer - the mutable text-editing structure behind editors like Emacs | Imperative arrays, mutable records, cursor locality, amortised O(1) edits, `Bytes.blit`, gap maintenance, growth by doubling |
...
├── gap_buffer.ml         # Gap buffer (editor text structure)
